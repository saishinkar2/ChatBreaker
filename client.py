...
class ChatClient:
    def __init__(self):
        ...
        self.message_input = tk.Entry(self.window,width=20)
    ...
    def select_issue(self):
        issues = ["Depression","Getting Diffrentiated By School","Weak in Acedemics(Please Describe)","Recommendation for Abroad Studies","Financial Suggestions","Other"]
